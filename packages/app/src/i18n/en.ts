export const dict = {
  ...
  "prompt.dictation.startWithCost": "Dictate with mimo-v2.5 · may increase usage cost",
  "prompt.dictation.stopWithCost": "Stop dictation {{time}} · sends audio to mimo-v2.5 and may increase usage cost",
  "prompt.dictation.transcribingWithModel": "Transcribing with mimo-v2.5...",
  "prompt.dictation.unavailableWithCost":
    "Dictation unavailable · Connect MiMo. Uses mimo-v2.5 and may increase usage cost",
