...
export const dict = {
  ...
  "prompt.dictation.startWithCost": "听写 · 调用 mimo-v2.5，可能增加使用成本",
  "prompt.dictation.stopWithCost": "停止听写 {{time}} · 停止后调用 mimo-v2.5，可能增加使用成本",
  "prompt.dictation.transcribingWithModel": "正在通过 mimo-v2.5 转写...",
  "prompt.dictation.unavailableWithCost": "听写不可用 · 请先连接 MiMo。功能会调用 mimo-v2.5，可能增加使用成本",
