...
export const dict = {
  ...
  "prompt.dictation.startWithCost": "聽寫 · 呼叫 mimo-v2.5，可能增加使用成本",
  "prompt.dictation.stopWithCost": "停止聽寫 {{time}} · 停止後呼叫 mimo-v2.5，可能增加使用成本",
  "prompt.dictation.transcribingWithModel": "正在透過 mimo-v2.5 轉寫...",
  "prompt.dictation.unavailableWithCost": "聽寫不可用 · 請先連線 MiMo。功能會呼叫 mimo-v2.5，可能增加使用成本",
