export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of MiMo Code Desktop",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of MiMo Code Desktop has been downloaded, would you like to install it and relaunch?",
