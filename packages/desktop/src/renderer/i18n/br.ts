export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do MiMo Code Desktop",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do MiMo Code Desktop foi baixada. Você gostaria de instalá-la e reiniciar?",
