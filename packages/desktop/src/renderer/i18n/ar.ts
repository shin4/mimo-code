export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من MiMo Code Desktop",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من MiMo Code Desktop، هل ترغب في تثبيته وإعادة تشغيله؟",
