export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji MiMo Code Desktop",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} MiMo Code Desktop. Czy chcesz ją zainstalować i uruchomić ponownie?",
