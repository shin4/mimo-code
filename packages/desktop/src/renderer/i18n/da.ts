export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af MiMo Code Desktop",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af MiMo Code Desktop er blevet downloadet. Vil du installere den og genstarte?",
