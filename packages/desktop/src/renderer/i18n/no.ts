export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av MiMo Code Desktop",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av MiMo Code Desktop er lastet ned. Vil du installere den og starte på nytt?",
