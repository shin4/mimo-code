export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju MiMo Code Desktop-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} MiMo Code Desktop-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
