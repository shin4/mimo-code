export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'MiMo Code Desktop",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'MiMo Code Desktop a été téléchargée. Voulez-vous l'installer et redémarrer ?",
